...
static const _Controls_type_support_symbol_names_t _Controls_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msgs_car, msg, Controls)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msgs_car, msg, Controls)),
  }
};
...
{
  return &::msgs_car::msg::rosidl_typesupport_cpp::Controls_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, msgs_car, msg, Controls)() {
  return get_message_type_support_handle<msgs_car::msg::Controls>();
}
