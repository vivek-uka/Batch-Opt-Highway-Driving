...
class sim():
    ...
    def plot(self):
        while True:
            ...
            ego_vehicles_x = [self.ours[self.loop][0], self.acado[self.loop][0], self.acado_2[self.loop][0], self.abal[self.loop][0], self.frenet[self.loop][0]]
            ego_vehicles_y = [self.ours[self.loop][1], self.acado[self.loop][1], self.acado_2[self.loop][1], self.abal[self.loop][1], self.frenet[self.loop][1]]
            ego_vehicles_psi = [self.ours[self.loop][2], self.acado[self.loop][2], self.acado_2[self.loop][2], self.abal[self.loop][2], self.frenet[self.loop][2]]
            ...
            plt.xlabel('Y in m')
            plt.ylabel('X in m')
            self.lower_lim = -30 + np.mean(ego_vehicles_x)
            self.upper_lim = self.upper + np.mean(ego_vehicles_x)
