...
int main( )
{
	...
	Expression dist1 = (pow(x - xo_1, 2)/aa + pow(y - yo_1, 2)/bb) ;
	Expression dist2 = (pow(x - xo_2, 2)/aa + pow(y - yo_2, 2)/bb) ;
	Expression dist3 = (pow(x - xo_3, 2)/aa + pow(y - yo_3, 2)/bb) ;
	Expression dist4 = (pow(x - xo_4, 2)/aa + pow(y - yo_4, 2)/bb) ;
	Expression dist5 = (pow(x - xo_5, 2)/aa + pow(y - yo_5, 2)/bb) ;
	Expression dist6 = (pow(x - xo_6, 2)/aa + pow(y - yo_6, 2)/bb) ;
	...
	Function h, hN;
	h << x << y << a << j << obs1 << obs2 << obs3 << obs4 << obs5 << obs6;				
	hN << x << y << theta << w;
